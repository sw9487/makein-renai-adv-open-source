**语言导航 / Languages / 言語:** [繁體中文](Illustrious - makein-renai-stable-diffusion.md) · [English](../en/Illustrious - makein-renai-stable-diffusion.md) · [日本語](../ja/Illustrious - makein-renai-stable-diffusion.md)
...
触发: Nukumizu Kazuhiko, short hair, black hair, brown eyes, ahoge
...
泳装: swimshorts (+blue hoodie)

体操服: gymwear

根据需要添加green necktie等修饰词可以拟合更加精确

防止女性化，可以加大1boy权重并添加male，在负面添加shota等
