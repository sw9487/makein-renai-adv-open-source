      ...
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        >
          <SheetHeader className="sr-only">
            <SheetTitle>{uiText("a11y.sidebar")}</SheetTitle>
            <SheetDescription>{uiText("a11y.mobileSidebar")}</SheetDescription>
          </SheetHeader>
...
function SidebarTrigger({
  ...
  return (
    ...
    >
      ...
      <span className="sr-only">{uiText("a11y.toggleSidebar")}</span>
    </Button>
  );
}
...
function SidebarRail({ className, ...props }: React.ComponentProps<'button'>) {
  ...
  return (
    <button
      ...
      aria-label={uiText("a11y.toggleSidebar")}
      tabIndex={-1}
      onClick={toggleSidebar}
      title={uiText("a11y.toggleSidebar")}
      className={cn(
